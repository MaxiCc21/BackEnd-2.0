...
//       text: "Recupera tu contraseña de Aerolíneas Argentinas",
//       html: `
...
//             <a href="https://example.com/reset-password?token=your-token-here" style="display: inline-block; padding: 10px 20px; font-size: 16px; color: #fff; background-color: #0044cc; text-decoration: none; border-radius: 5px;">
...
const transporter = nodemailer.createTransport({
  ...
  secure: false,
  auth: {
    user: "maxi21498@gmail.com",
    pass: "gyje jihr kktr yetb",
  },
});
